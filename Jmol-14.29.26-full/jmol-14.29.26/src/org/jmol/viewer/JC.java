/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2018-04-19 14:39:19 -0500 (Thu, 19 Apr 2018) $
 * $Revision: 21899 $
...
public final class JC {
  ...
  public final static int CIP_CHIRALITY_p_FLAG = CIP_CHIRALITY_P_FLAG | CIP_CHIRALITY_PSEUDO_FLAG;
  ...
  static Map<String, String> databases = new Hashtable<String, String>();
  ...
  static String fixProtocol(String name) {
    ...
    if (name.indexOf("http://www.rcsb.org/pdb/files/") == 0) {
      boolean isLigand = (name.indexOf("/ligand/") >= 0);
      String id = name.substring(name.lastIndexOf("/") + 1);
      return resolveDataBase(null, id, databases.get(isLigand ? "ligand" : "pdb"));
    }
    return (name.indexOf("http://www.ebi") == 0
